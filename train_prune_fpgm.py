...
class Mask:
    ...
    def get_filter_codebook(self, weight_torch, compress_rate, length):
        ...
        if len(weight_torch.size()) == 4:
            filter_pruned_num = int(weight_torch.size()[0] * (1 - compress_rate)) + 1
    ...
    def init_mask(self, rate_norm_per_layer, rate_dist_per_layer, layer_begin, layer_end, use_cuda):
        self.init_rate(rate_norm_per_layer, rate_dist_per_layer, layer_begin, layer_end)
        for index, item in enumerate(self.model.parameters()):
